- dashboard: aws_cost_and_usage_overview
  ...
  - name: Total Cost Latest Week
    ...
    - my_cur_report.usage_start_week
    fill_fields:
    - my_cur_report.usage_start_week
    sorts:
    - my_cur_report.usage_start_week desc
    limit: 500
    column_limit: 50
    dynamic_fields:
    - table_calculation: cost_last_week
      label: Cost Last Week
      expression: offset(${my_cur_report.total_blended_cost},1)
      value_format:
  ...
  - name: Total Cost Latest Month
    ...
    - my_cur_report.usage_start_month
    sorts:
    - my_cur_report.usage_start_month desc
    limit: 500
    column_limit: 50
    dynamic_fields:
    - table_calculation: cost_last_week
  ...
  - name: Total Cost YTD
    ...
    fields:
    - my_cur_report.total_blended_cost
    - my_cur_report.usage_start_year
    fill_fields:
    - my_cur_report.usage_start_year
    sorts:
    - my_cur_report.usage_start_year desc
    limit: 500
    column_limit: 50
    dynamic_fields:
  ...
  - name: Reserved EC2 Cost Latest Month
    ...
    - my_cur_report.usage_start_month
    filters:
      my_cur_report.ri_line_item: RI Line Item
    sorts:
    - my_cur_report.usage_start_month desc
    limit: 500
    column_limit: 50
    ...
    - table_calculation: cost_last_month
      ...
      expression: offset(${my_cur_report.EC2_blended_cost},1)
      value_format:
      value_format_name: usd_0
  ...
  - name: Non Reserved EC2 Cost Latest Month
    ...
    - my_cur_report.usage_start_month
    filters:
      my_cur_report.ri_line_item: Non RI Line Item
    sorts:
    - my_cur_report.usage_start_month desc
    limit: 500
    column_limit: 50
  ...
  - name: Total Cost by Reservation Type
    ...
    - my_cur_report.usage_start_month
    sorts:
    - my_cur_report.total_blended_cost desc 0
    - my_cur_report.ri_line_item
    limit: 500
    column_limit: 50
    query_timezone: America/Los_Angeles
    ...
    - "#B1B0B0"
    series_colors:
      Non RI Line Item - my_cur_report.total_blended_cost: "#39A736"
    row: 16
    col: 0
    width: 12
    height: 8
  - name: Total Cost and RI Efficiency
    ...
    fields:
    - my_cur_report.total_blended_cost
    - my_cur_report.total_reserved_blended_cost
    - my_cur_report.total_non_reserved_blended_cost
    - my_cur_report.usage_start_month
    fill_fields:
    - my_cur_report.usage_start_month
    sorts:
    - my_cur_report.total_blended_cost desc
    limit: 500
    column_limit: 50
    dynamic_fields:
    - table_calculation: percent_of_spend_on_ris
      label: Percent of Spend on RI's
      expression: "${my_cur_report.total_reserved_blended_cost}/${my_cur_report.total_blended_cost}"
      value_format:
      value_format_name: percent_0
    - table_calculation: percent_of_spend_on_non_ris
      label: Percent of Spend on Non-RIs
      expression: "${my_cur_report.total_non_reserved_blended_cost}/${total_blended_cost}"
      value_format:
      value_format_name: percent_0
    - table_calculation: total_blended_cost
      label: Total Blended Cost
      expression: "${my_cur_report.total_blended_cost}"
      value_format:
      value_format_name: usd_0
    query_timezone: America/Los_Angeles
    stacking: ''
  ...
  - name: Total EC2 Cost by Reservation Type
    ...
    series_colors:
      Non RI Line Item - my_cur_report.total_blended_cost: "#39A736"
      Non RI Line Item - my_cur_report.EC2_blended_cost: "#39A736"
    row: 24
    col: 0
    width: 12
    height: 8
  - name: EC2 Cost and RI Efficiency
    ...
    - my_cur_report.usage_start_month
    - my_cur_report.EC2_blended_cost
    - my_cur_report.EC2_reserved_blended_cost
    - my_cur_report.EC2_non_reserved_blended_cost
    fill_fields:
    - my_cur_report.usage_start_month
    sorts:
    - my_cur_report.usage_start_month
    ...
    - table_calculation: percent_of_ec2_cost_reserved
      ...
      expression: "${my_cur_report.EC2_reserved_blended_cost}/${my_cur_report.EC2_blended_cost}"
      value_format:
      value_format_name: percent_0
    - table_calculation: percent_of_ec2_cost_non_reserved
      label: Percent of EC2 Cost - Non Reserved
      expression: "${my_cur_report.EC2_non_reserved_blended_cost}/${my_cur_report.EC2_blended_cost}"
      value_format:
      value_format_name: percent_0
    - table_calculation: total_ec2_blended_cost
      label: Total EC2 Blended Cost
      expression: "${my_cur_report.EC2_blended_cost}"
      value_format:
      value_format_name: usd_0
    query_timezone: America/Los_Angeles
    stacking: ''
  ...
  - name: Most Costly Services
    ...
    - my_cur_report.average_blended_cost_per_month
    - my_cur_report.total_blended_cost
    - my_cur_report.total_reserved_blended_cost
    sorts:
    - my_cur_report.total_blended_cost desc
    ...
    series_types:
      my_cur_report.average_blended_cost_per_month: line
      reservation_efficiency: line
      average_blended_cost_per_month: line
    series_colors:
      my_cur_report.total_blended_cost: "#3B4260"
  ...
  - name: Cost by Product (Full Detail)
    ...
    - label:
      ...
      valueFormat:
      series:
      - id: my_cur_report.average_blended_cost_per_month
    ...
    - label: ''
      ...
      valueFormat:
      series:
      - id: my_cur_report.total_blended_cost
  ...
  - name: Cost by Usage Type (Top 10)
    ...
    series_colors:
      my_cur_report.total_blended_cost: "#3B4260"
      my_cur_report.average_blended_cost_per_month: "#1D98D3"
      total_blended_cost: "#3B4260"
      reservation_efficiency: "#1D98D3"
    y_axes:
    - label:
  ...
  - name: Cost by Usage Type (Full Detail)
    ...
    - my_cur_report.ri_line_item
    sorts:
    - my_cur_report.total_blended_cost desc 1
    - my_cur_report.ri_line_item 0
    limit: 500
    column_limit: 50
    query_timezone: America/Los_Angeles
    show_view_names: true
